...
TEST(LEXING_MATERIAL_FILES, newmtl_token){
    auto m = parse_stripped_line(std::stringstream("newmtl Material"), material_token_map, 1);
...
TEST(LEXING_MATERIAL_FILES, Ns_token){
    auto m = parse_stripped_line(std::stringstream("Ns 250.000000"), material_token_map, 1);
    EXPECT_TRUE(m.has_value());
...
TEST(LEXING_MATERIAL_FILES, Ka_token){
    auto m = parse_stripped_line(std::stringstream("Ka 1.000000 1.000000 1.000000"), material_token_map, 1);
    EXPECT_TRUE(m.has_value());
...
TEST(LEXING_MATERIAL_FILES, Kd_token){
    auto m = parse_stripped_line(std::stringstream("Kd 0.800000 0.800000 0.800000"), material_token_map, 1);
    EXPECT_TRUE(m.has_value());
...
TEST(LEXING_MATERIAL_FILES, Ks_token){
    auto m = parse_stripped_line(std::stringstream("Ks 0.500000 0.500000 0.500000"), material_token_map, 1);
    EXPECT_TRUE(m.has_value());
...
TEST(LEXING_MATERIAL_FILES, Ni_token){
    auto m = parse_stripped_line(std::stringstream("Ni 1.450000"), material_token_map, 1);
    EXPECT_TRUE(m.has_value());
...
TEST(LEXING_MATERIAL_FILES, d_token){
    auto m = parse_stripped_line(std::stringstream("d 1.000000"), material_token_map, 1);
    EXPECT_TRUE(m.has_value());
...
TEST(LEXING_MATERIAL_FILES, not_a_token){
    auto m = parse_stripped_line(std::stringstream("Ke 0.000000 0.000000 0.000000"), material_token_map, 1);
